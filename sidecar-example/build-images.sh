...
# docker build --build-arg HTTP_PROXY=http://your-proxy:port --build-arg HTTPS_PROXY=http://your-proxy:port -f Dockerfile.main-app -t sidecar-main-app:latest .
...
# 如果需要代理，取消注释下面这行并设置正确的代理地址
# docker build --build-arg HTTP_PROXY=http://your-proxy:port --build-arg HTTPS_PROXY=http://your-proxy:port -f Dockerfile.sidecar -t sidecar-sidecar:latest .
